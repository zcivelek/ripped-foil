...
scatter.int3 <- ggplot(data=ripchild_open, aes(x=agemonths, y=correct, group=openended)) +
  geom_point(data=ripchild_open, aes(x = agemonths, y = correct), size = ripchild_open$n, alpha = 0.8) +
  facet_wrap(~openended) + 
